...
Scanner scan = new Scanner(System.in);
		...
		if (litrosTotais % 3.6 == 0 && litrosTotais / 3.6 == 1) {
			nlatas3_6= (litrosTotais/3.6);
		}else {
			nlatas3_6= (litrosTotais/3.6)+1;
		}
